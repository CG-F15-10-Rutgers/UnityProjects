...
public class BotControlScript : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		anim.SetFloat("Speed", v, 1f, Time.deltaTime * 10f);							// set our animator's float parameter 'Speed' equal to the vertical input axis				
		anim.SetFloat("Direction", h, 1f, Time.deltaTime * 10f); 						// set our animator's float parameter 'Direction' equal to the horizontal input axis		
